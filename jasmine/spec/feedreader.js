...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it ('has defined URL, URL is not empty', function() {
         ...
         */
        it ('has defined name, name is not empty', function() {
            allFeeds.forEach(function(feed) {
    ...
    describe('The menu', function() {
        ...
        it ('element is hidden by default', function() {
            const hiddenMenu = document.querySelector('body');
    ...
    describe ('Initial Entries', function() {
        ...
        it ('has at least a single .entry element within the .feed container', function(done) {
            ...
            const entryElement = feedContainer.querySelector('.entry');
    ...
    describe("New Feed Selection", function() {
        ...
        it("when loaded, the content changes", function(done) {
